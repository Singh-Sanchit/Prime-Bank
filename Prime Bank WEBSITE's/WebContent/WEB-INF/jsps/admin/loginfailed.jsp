...
<div class="unicorn"></div>
    ...
    <div class="container">
        ...
        <div class="four-oh-four"><h1>Login Failed</h1></div>
              
        <div class="warning">            
            <h2>"Contact Your Organization And Get Proper Credentials To Access The Platform."</h2>
            <p>The page you are looking for have authorized access, users with proper authority have the rights to access this facility.</p>
            <a href="javascript:history.back()">Please go back to the previous page</a>
        </div>

        <div class="footer"><p class="copyright">&copy; 2018, Prime Bank</p></div>        
