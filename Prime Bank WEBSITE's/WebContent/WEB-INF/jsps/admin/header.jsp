	...
	-->
			...
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li><a href="${pageContext.request.contextPath }/Statement">
		...
		<div class="main-panel">
			...
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="${pageContext.request.contextPath }/">Welcome <c:out
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a class="dropdown-toggle"
							data-toggle="dropdown"> <i class="ti-panel"></i>
								<p>Stats</p> <b class="caret"></b>
						</a>
							<ul class="dropdown-menu">
							<li><a><h5>Accounts Created By You:</h5></a></li>
								<c:forEach var="customer" items="${list}">
									<c:if test="${username == customer.getCreatedBy() }">
										<li><a><c:out value="${customer.getFname() }" /> <c:out
												value="${customer.getMname() }" /> <c:out
												value="${customer.getLname() }" /></a></li>
									</c:if>
								</c:forEach>
							</ul>
						</li>
						<li><a href="${pageContext.request.contextPath }/Report">
								<i class="ti-pencil-alt"></i>
								<p>Report</p>
						</a></li>
