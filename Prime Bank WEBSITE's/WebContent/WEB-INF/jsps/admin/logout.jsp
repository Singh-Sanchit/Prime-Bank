...
<div class="text">
  <div class="text-inner">
    ...
    <h2> We thank you for your important time spending with us. </h2>

    <div id="home" class="button">
     <h4> <a href="${pageContext.request.contextPath }/" style="color: inherit;text-decoration: none;">LOGIN</a></h4>
    </div>
	</div>
